...
export async function PublicHeader() {
  ...
  return (
    <header suppressHydrationWarning data-scroll-hide data-scroll-hidden="false" className="sticky top-0 z-50 border-b border-line/70 bg-surface/90 backdrop-blur-xl">
