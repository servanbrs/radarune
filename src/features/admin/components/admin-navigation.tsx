...
export const adminNavigationGroups = [
  { title: "Genel", items: [{ href: "/admin", label: "Genel Bakış" }, { href: "/admin/users", label: "Kullanıcılar" }, { href: "/admin/users/new", label: "Kullanıcı ekle" }, { href: "/admin/artists", label: "Sanatçılar" }, { href: "/admin/applications", label: "Başvurular" }] },
