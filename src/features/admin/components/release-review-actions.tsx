...
export function ReleasePreview({ artworkUploadId, artworkUpload, audioUploadId, audioUpload, uploads = [], tracks = [] }: { artworkUploadId: string | null; artworkUpload?: { id: string; fileName: string; mimeType: string } | null; audioUploadId: string | null; audioUpload?: { id: string; fileName: string; mimeType: string } | null; uploads?: Array<{ id: string; fileName: string; mimeType: string; kind?: string }>; tracks?: Array<{ id: string; title: string; audioUploadId: string | null; uploads: Array<{ id: string; fileName: string; mimeType: string }> }> }) {
