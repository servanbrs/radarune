...
export function ReleasePreview({ artworkUploadId, artworkUpload, audioUploadId, audioUpload }: { artworkUploadId: string | null; artworkUpload?: { id: string; fileName: string; mimeType: string } | null; audioUploadId: string | null; audioUpload?: { id: string; fileName: string; mimeType: string } | null }) {
