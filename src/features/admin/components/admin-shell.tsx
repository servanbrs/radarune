      ...
      <div className="mx-auto flex min-h-screen w-full max-w-[1920px]">
        ...
        <section className="min-w-0 flex-1 bg-[#0d1c1a] text-[#eef7f5]">
          <header className="sticky top-0 z-20 flex min-h-[86px] items-center justify-between border-b border-white/[0.08] bg-[#0d1c1a]/95 px-4 backdrop-blur-xl sm:px-7 lg:px-10">
            ...
            <div className="flex items-center gap-2 sm:gap-3"><span className="hidden items-center gap-2 rounded-full border border-emerald-300/15 bg-emerald-300/[0.08] px-3 py-2 text-xs font-semibold text-emerald-200 md:flex"><span className="size-2 animate-pulse rounded-full bg-emerald-300" /> Sistemler normal</span><Link aria-label="Yardım ve destek merkezini aç" className="flex size-9 items-center justify-center rounded-xl border border-white/10 bg-[#162a27] text-emerald-200 transition hover:border-emerald-300/30 hover:bg-[#1d3832]" href="/admin/support" title="Yardım ve destek"><CircleHelp className="size-4" /></Link><Link className="hidden items-center gap-2 rounded-xl bg-[#55e3b2] px-3 py-2 text-xs font-bold !text-[#06221a] transition hover:bg-[#82f0c8] sm:flex" href="/">Anasayfayı gör <ExternalLink className="size-3.5" /></Link></div>
          </header>
          <div className="border-b border-white/[0.08] bg-[#10221f] px-4 py-3 lg:hidden"><AdminNavigation systemRole={user.systemRole} /></div>
