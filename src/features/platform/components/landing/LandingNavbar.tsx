...
export async function LandingNavbar() {
  ...
  return (
    <header suppressHydrationWarning data-scroll-hide data-scroll-hidden="false" className="sticky top-0 z-50 border-b border-white/10 bg-[#080a0e]/80 backdrop-blur-2xl">
