        ...
        <div className="grid gap-8 p-6 md:p-10 lg:grid-cols-[1.5fr_1fr]">
          <div>
            ...
            <div className="mt-4 grid gap-3 sm:grid-cols-2">
              {artist.releaseArtistLinks.map((link) => <div className="rounded-2xl border border-line bg-surface-strong p-4" key={link.id}><p className="font-semibold">{link.release.title}</p><p className="mt-1 text-xs text-muted">{link.release.primaryGenre}</p></div>)}
