        ...
        <section className="overflow-hidden rounded-[2.4rem] bg-[#071612] text-white shadow-[0_30px_100px_rgba(4,24,20,0.25)]">
          <div className="grid gap-8 p-6 sm:p-10 md:grid-cols-[minmax(240px,360px)_1fr] md:items-center">
            ...
            <div className="min-w-0">
              ...
              <div className="mt-8 flex items-center gap-3"><TrackPlayButton trackId={track.id} className="size-14 bg-[#54e7c2] text-[#071612] hover:bg-white" /><span className="text-sm font-semibold text-white/55">Radarune içinde dinle</span></div>
            </div>
          </div>
        </section>
