      ...
      <section className="panel p-6">
        ...
        <form action={saveWhatsappAction} className="mt-6 grid gap-4">
          <div className="grid gap-4 md:grid-cols-2">
            <label className="grid gap-2 text-sm font-medium">Telefon numarası ID<input className="rounded-xl border border-line bg-background px-4 py-3" name="phoneNumberId" placeholder="Meta WhatsApp Phone Number ID" required /></label>
            <label className="grid gap-2 text-sm font-medium">Business Account ID<input className="rounded-xl border border-line bg-background px-4 py-3" name="businessAccountId" placeholder="WABA ID" /></label>
            ...
            <label className="grid gap-2 text-sm font-medium md:col-span-2">Bildirim alacak numaralar<textarea className="min-h-24 rounded-xl border border-line bg-background px-4 py-3" name="recipients" placeholder="905xxxxxxxxx\n905yyyyyyyyy" required /></label>
            <label className="grid gap-2 text-sm font-medium">Şablon adı<input className="rounded-xl border border-line bg-background px-4 py-3" defaultValue="radarune_new_release" name="templateName" required /></label>
            <label className="grid gap-2 text-sm font-medium">Şablon dili<input className="rounded-xl border border-line bg-background px-4 py-3" defaultValue="tr" name="templateLanguage" required /></label>
          </div>
