      ...
      <section className="panel p-6">
        ...
        <form action={saveWhatsappAction} className="mt-6 grid gap-4">
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <label className="grid gap-2 text-sm font-medium md:col-span-2">Meta doğrulama belirteci<input className="rounded-xl border border-line bg-background px-4 py-3" defaultValue={config?.verifyToken ?? "radarune_whatsapp_verify"} name="verifyToken" required /><span className="text-xs font-normal text-muted">Meta Webhooks ekranındaki “Belirteci doğrula” alanına bu değeri aynen yazın.</span></label>
          </div>
