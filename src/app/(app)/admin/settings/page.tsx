    ...
    >
      <section id="smtp" className="panel mb-5 grid gap-5 p-6">
        ...
        <form action={updateSmtpSettingsAction} className="grid gap-4">
          ...
          <label className="text-sm font-medium text-foreground">Değişiklik sebebi<input name="reason" minLength={10} required className="mt-2 w-full rounded-xl border border-line bg-surface-strong px-4 py-3 text-foreground outline-none placeholder:text-muted focus:border-accent focus:ring-2 focus:ring-accent/10" placeholder="SMTP ve e-posta şablonlarını güncelledim" /></label><button className="w-fit rounded-full bg-accent px-5 py-3 font-semibold text-accent-foreground" type="submit">SMTP ve şablonları kaydet</button>
        </form>
